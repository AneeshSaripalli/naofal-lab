...
const string usage = "\n"
                     ...
                     "                   head band, car calib 0.016\n"
                     "                   Apricap 0.032\n"
                     "                   reference 0.032\n"
                     "		         ### old: road calib 0.176\n"
                     "                   white screen 0.16\n"
...
public:
  ...
  void print_detection(AprilTags::TagDetection &detection, int frame = -1) const
  {
    std::ofstream writefile;
...
{
  cout << "Logging CSV data to " << outputfile << std::endl;
