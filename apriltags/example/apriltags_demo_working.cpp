...
/* if(!outputVideo.isOpened()) {
   ...
   cout << "Actual resolution: "
      ...
      writefile.open("/home/marzban/AprilTagMIT/output/data.csv",std::ofstream::out);
...
writefile.close();
  ...
  void print_detection(AprilTags::TagDetection& detection) const {
      std::ofstream writefile;
      writefile.open("/home/marzban/AprilTagMIT/output/data.csv",std::ofstream::out | std::ofstream::app);
...
writefile.close();
  ...
  void processImage(cv::Mat& image, cv::Mat& image_gray) {
    ...
    for (int i=0; i<detections.size(); i++) {
      ...
      writefile.open("/home/marzban/AprilTagMIT/output/data.csv",std::ofstream::out | std::ofstream::app);
//    cout<<"\nbefore draw1\n";
      writefile<<"2222\t2222\t2222\t2222\t2222\t2222\t2222\t2222\t2222\n";
//    cout<<"\nbefore draw2\n";
    writefile.close();
