...
def calib_row(row, back_face_tfm, face_ref_curr_tfm):
   ...
   #print("ORG COM", com)
    com_tfm = apply_tfms(com, back_face_tfm, face_ref_curr_tfm)
...
def orchestrate_fg(apriltag, anglesId, refBack, refFace):
    print("Calib")
...
if __name__ == "__main__":
    ...
    orchestrate_fg(args.apriltag, args.anglesId, args.refBack, args.refFace)
