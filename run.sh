...
./build/bin/apriltags_demo -F 1000 -W 1920 -H 1080 -S 0.176 -I $1 -O "$AP_BACK" -d -f & 
./build/bin/apriltags_demo -F 1000 -W 1920 -H 1080 -S 0.176 -I $2 -O "$AP_ROAD" -d -f &
./build/bin/apriltags_demo -F 1000 -W 1920 -H 1080 -S 0.032 -I $1 -O "$HAT_BACK" -d -f
...
python3 apriltags/scripts/unify_road_and_head.py      $STD_VIS     $STD_ROAD  $3
