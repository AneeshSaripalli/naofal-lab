...
Ref_Calib_Back="output/referenceCalibration/BackCalibrationAll.pickle"
...
#./apriltags/build/bin/apriltags_demo -F 1000 -W 1920 -H 1080 -S 0.04 -I $1 -O "$AprilTag_Calib_Back" -b 15 -e 79200 -d -f &
